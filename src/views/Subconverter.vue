  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "http://192.168.2.222:25500/sub?" }],
        remoteConfig: [
          {
            label: "EMBY公益服专用-精简",
            options: [
              {
                label: "ACL4SSR_Online 默认版 内含openai和emby公益服分流",
                value:
                  "https://raw.githubusercontent.com/acnixuil/Test_sub/main/Sub.ini"
              }
            ]
          },
          {
